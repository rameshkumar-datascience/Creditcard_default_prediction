...
from creditcard.entity.artifact_config import DataTransformationArtifact, ModelTrainerArtifact
...
from creditcard.entity.model_factory import MetricInfoArtifact, ModelFactory,GridSearchedBestModel
from creditcard.entity.model_factory import evaluate_classification_model
# evaluate classification model is needed inplace of above


class CreditcardEstimatorModel:
    def __init__(self, preprocessed_object, trained_model_object):
        """
    ...
    def predict(self, X):
        """
        function accepts raw inputs and then transformed raw input using preprocessed_object
        which gurantees that the inputs are in the same format as the training data
        At last it perform prediction on transformed features
        """
        transformed_feature = self.preprocessed_object.transform(X)
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            credit_model = CreditcardEstimatorModel(preprocessed_object=preprocessed_obj,trained_model_object=model_object)
